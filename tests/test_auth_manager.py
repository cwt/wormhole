...
class TestAuthManager:
    ...
    def test_add_user_existing_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            existing_users = {'existinguser': {'realm': REALM, 'hash': 'existinghash'}}
    ...
    def test_add_user_already_exists(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            existing_users = {'testuser': {'realm': REALM, 'hash': 'existinghash'}}
            _write_auth_file(Path(auth_file), existing_users)
    ...
    def test_modify_user_not_found(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            existing_users = {'otheruser': {'realm': REALM, 'hash': 'existinghash'}}
            _write_auth_file(Path(auth_file), existing_users)
