...
class TestLogThrottler:
    ...
    async def test_log_throttler_repeated_message(self):
        ...
        mock_logger = Mock()
        throttler = LogThrottler(mock_logger, "info", delay=0.1)  # Short delay for testing
        ...
        mock_logger.opt().log.assert_called_once_with("INFO", "Repeated message")
...
class TestSetupLogger:
    ...
    def test_setup_logger_basic(self):
        ...
        with patch('wormhole.logger.logger.remove'), \
