...
class TestAuthentication:
    ...
    def test_parse_digest_header_quoted_values(self):
        ...
        header = 'Digest username="testuser", realm="Wormhole Proxy", nonce="abc123"'
    ...
    async def test_verify_credentials_valid_credentials(self):
        ...
        try:
            ...
            response_data = f"{ha1}:abc123:00000001:xyz789:auth:{ha2}".encode("utf-8")
            ...
            with patch("wormhole.authentication.secrets.compare_digest", return_value=True):
                # Call verify_credentials
                result = await verify_credentials(
                    mock_reader,
                    mock_writer,
